---
name: sales-pipeline
description: AI-powered sales pipeline management and optimization. Builds pipeline stages, tracks deal velocity, identifies bottlenecks, and generates next-action recommendations. Use when asked to build a sales pipeline, optimize deal flow, analyze pipeline health, or improve close rates.
user_invocable: true
---
