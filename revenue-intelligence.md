...
description: AI-powered revenue analysis and forecasting. Analyzes revenue streams, identifies expansion opportunities, models pricing scenarios, and generates actionable revenue growth plans. Use when asked for revenue analysis, pricing strategy, upsell opportunities, or revenue forecasting.
user_invocable: true
---
