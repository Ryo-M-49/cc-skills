---
name: sales-playbook
description: AI Sales Playbook for value-based pricing and deal upselling. Generates objection handling scripts, pricing conversation frameworks, upsell sequences, and deal negotiation tactics. Use when asked to build a sales playbook, handle pricing objections, design upsell strategies, or coach on value-based selling.
user_invocable: true
---
